...
routes['POST']['/addApp'] = 'Appointments#create'
routes['POST']['/appointment/delete/<id>'] = 'Appointments#delete'
routes['POST']['/appointment/edit/<id>'] = "Appointments#edit"
routes['POST']['/appointment/update/<id>'] = "Appointments#update"
"""
